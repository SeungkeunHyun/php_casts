<?php
	...
	*/
	...
	//error_log( print_r($finfo, TRUE), 3, "e:/temp/php7.log" );	
	...
	//$id3Writer->tagformats = array('id3v2.4', 'lyrics3', 'ape', 'id3v1');
	...
	if ($id3Writer->WriteTags()) {
		error_log('Successfully wrote tags', 3, "e:/temp/php7.log");
	} elseif (!empty($id3Writer->warnings)) {
		error_log('There were some warnings: '.implode("\r\n", $id3Writer->warnings), 3, "e:/temp/php7.log");
	} else {
		error_log('There were some warnings: '.implode("\r\n", $id3Writer->errors), 3, "e:/temp/php7.log");
	}
